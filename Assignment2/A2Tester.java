public class A2Tester {
	...
	public static void testTotalFans() {
		...
		Player p8 = new Player("green",15, 0);
		...
		result = t5.totalFans();
		expected = 0;
		displayResults(result==expected, "total fans of t5");
	...
	public static void testGetYoungest() {
		...
		Player[] arr1 = {p1, p2};
		Player[] arr2 = {p5, p3, p6, p1};
		Player[] arr3 = {p3, p3, p6, p2};
		Player[] arr4 = {p3, p3, p3, p3};
		Player[] arr5 = {p5};
		
		Team t0 = new Team("Rivals",   empty);
		Team t1 = new Team("Champions", arr1);
		Team t2 = new Team("Gunters",   arr2);
		Team t3 = new Team("Greens",   arr3);
		Team t4 = new Team("same",   arr4);
		Team t5 = new Team("one",   arr5);
	...
	public static void testGetPlayer() {
		...
		Player[] arr1 = {p1, p2};
		Player[] arr2 = {p5, p3, p6, p1};
		Player[] arr3 = {p1, p5, sameName1};
		
		Team t0 = new Team("Rivals",   empty);
		Team t1 = new Team("Champions", arr1);
		Team t2 = new Team("Gunters",   arr2);
		Team t3 = new Team("Green",   arr3);
	...
	public static void testGoingViral() {
		...
		t1.goingViral("Parzival", 0);
		result = p1.getFans();
		expected = 31348;
		displayResults(result==expected, "add 0 fans to " + p1);
		result = sameName1.getFans();
		expected = 99999;
		displayResults(result==expected, "addFans only modifies first match");
		result = p1.getFans();
	...
	public static void testMoreFans() {
		...
		Player p5 = new Player("The Rock", 50, 0);
		Player p6 = new Player("The Rock", 50, 0);
		...
		result = A2Exercises.moreFans(p1, p1);
		expected = p1;
		displayResults(result.equals(expected), "moreFans(p1, p3)");

		result = A2Exercises.moreFans(p1, p5);
		expected = p1;
		displayResults(result.equals(expected), "moreFans(p1, p3)");

		result = A2Exercises.moreFans(p6, p5);
		expected = p6;
		displayResults(result.equals(expected), "moreFans(p1, p3)");
	...
	public static void testCountAbove() {
		...
		result = A2Exercises.countAbove(t4, 0);
		expected = 6;
		displayResults(result==expected, "players in t1 with more than 0 fans");
		// TODO: Write additional tests here
